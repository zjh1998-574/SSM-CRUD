    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p id="emp_confrim_delete_content">
                </p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
                <button type="button" class="btn btn-primary" id="emp_delete_btn">确认</button>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="modal-body">
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="email" class="form-control" id="email_update_input" placeholder="email@cqupt.com">
            ...
            <div class="modal-body">
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="email" class="form-control" id="email_add_input" placeholder="email@cqupt.com">
                            <span class="help-block"></span>
                        </div>
                    </div>
                    <div class="form-group">
...
<script type="text/javascript">
    ...
    function validate_add_form() {
        ...
        var regExpName=/(^[a-zA-Z0-9_-]{6,16}$)|(^[\u2E80-\u9FFF]{2,5})/;
    ...
    $("#emp_save_btn").click(function (){
        ...
        // 1.1先对要提交给服务器的数据进行校验(前端的校验)
        if (!validate_add_form()){
            return false;
        };
        // 1.2 判断之前的ajax用户名检验是否成功
    ...
    $(document).on("click",".delete_btn",function () {
        ...
        $("#emp_confrim_delete_content").text("确认删除【"+empName+"】吗？");
    ...
    $("#emp_delete_all_btn").click(function () {
        ...
        $("#emp_confrim_delete_content").text("确定要删除【"+empNames+"】吗？");
        $("#empDeleteModal").modal({
            backdrop:"static"
        });
